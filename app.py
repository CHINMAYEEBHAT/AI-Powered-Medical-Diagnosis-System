...
background_image_url = "https://repository-images.githubusercontent.com/347478889/af86a62f-8439-4645-b4d9-71a90e8c78d7"  # Replace with your image URL
...
with open('Models/parkinsons_model.sav', 'rb') as file:
    models['parkinsons'] = pickle.load(file)

with open('Models/lungs_disease_model.sav', 'rb') as file:
    models['lung_cancer'] = pickle.load(file)

with open('Models/Thyroid_model.sav', 'rb') as file:
    models['thyroid'] = pickle.load(file)
